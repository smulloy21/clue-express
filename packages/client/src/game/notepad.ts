 ...
 * so replaying it through the same knowledge base gives an auto-maintained notepad of everything
 * they can *provably* deduce (their own hand, cards shown to them, and inference from public
 * disprovals), with no cheating: it's the identical reasoning the server's own hard bots use.
 */
